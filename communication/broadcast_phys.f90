...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(physics_pc_coupled,     1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(physics_pc_schur_u,    1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,physics_pc_coupled,     1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,physics_pc_schur_u,    1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
