...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(physics_pc_reassemble,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(physics_pc_block_inv,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(metriplectic_analysis,        1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(commutator_analysis,          1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(metriplectic_analysis_nsweep, 1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(use_metriplectic_pc,          1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(metriplectic_sweep_order,     2,MPI_CHARACTER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(metriplectic_khalf,           2,MPI_CHARACTER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(metriplectic_ps_inner_it,     1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(metriplectic_ps_inner_tol,    1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(commutator_pc,                1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(commutator_pc_mstar,          4,MPI_CHARACTER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(commutator_pc_inner_it,       1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(commutator_pc_inner_tol,      1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(commutator_pc_ab,             1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(commutator_pc_ab_variants,   64,MPI_CHARACTER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(commutator_pc_ab_every,       1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,physics_pc_reassemble,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,physics_pc_block_inv,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,metriplectic_analysis,        1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,commutator_analysis,          1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,metriplectic_analysis_nsweep, 1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,use_metriplectic_pc,          1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,metriplectic_sweep_order,     2,MPI_CHARACTER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,metriplectic_khalf,           2,MPI_CHARACTER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,metriplectic_ps_inner_it,     1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,metriplectic_ps_inner_tol,    1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,commutator_pc,                1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,commutator_pc_mstar,          4,MPI_CHARACTER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,commutator_pc_inner_it,       1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,commutator_pc_inner_tol,      1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,commutator_pc_ab,             1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,commutator_pc_ab_variants,   64,MPI_CHARACTER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,commutator_pc_ab_every,       1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
