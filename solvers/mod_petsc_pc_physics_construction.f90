...
#include "petsc/finclude/petsc.h"
  ...
  use mod_petsc_pc_blocks, only: pc_print_block_setup, create_variable_index_sets, &
       extract_sub_block, extract_sub_block_h, extract_sub_blocks_h, &
...
contains
  ...
  ! pc_print_block_setup, create_variable_index_sets, extract_sub_block[s][_h]
  ! moved to mod_petsc_pc_blocks (value-neutral move; see that module header).
...
!--------------------------------------------------------------------
  ...
  ! report_operator_density moved to mod_petsc_pc_blocks.
  ...
  !--------------------------------------------------------------------
  ! pack_pair_aij moved to mod_petsc_pc_blocks.
  ...
  ! make_pair_block_scale moved to mod_petsc_pc_blocks.
